...
Shader ".poiyomi/Master/Opaque"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            Tags { "LightMode" = "ForwardBase" "RenderType" = "Overlay"  "Queue" = "Overlay+214748364" "IsEmissive" = "true" "DisableBatching"= "true" "ForceNoShadowCasting" = "true" "IgnoreProjector" = "true" }
            Stencil
            {
